...
import testPhone from './../../public/images/iphone12promax.png'
      ...
      <>
          ...
          <Tilt>
                  <div className="wrap" key='1'>
                    ...
                    <div className="image">
                      <img src={testPhone.src} alt={'phone'}/>
                    </div>
                      <div className="text">
                        <b>Iphone 12 mini</b>
                      <span>452000</span><br></br>
                      <i>Kanxik 425000 DRAM</i>
                      <p><span>Amsekan</span>31000 AMD</p>
                    </div>
                    <span className="advance"><AddShoppingCartIcon /> Advance</span>
                ...
                return(
                  ...
                  <div className="wrap" key={e.id}>
                    ...
                    <div className="image">
                      ...
                      <div className="text">
                        <b>{e.name}</b>
                      <span>{e.price}</span><br></br>
                      {e.cash !== '' ?  <i>Kanxik {e.cash} DRAM</i> : null}
                      {e.credit !== '' ?  <p><span>Amsekan</span> {e.credit} AMD</p> : null}
                    </div>
                    <span className="advance"><AddShoppingCartIcon /> Advance</span>
                    {/* <a href="/newmobile/product/' . $link . '/' . $row['id'] . '-' .  $row["REPLACE(name, ' ', '-')"] . '_' .$row['id'] . '.php"  className="advance" data-id="' . $row['id'] . '">Avelin</a> */}
                      </div>
